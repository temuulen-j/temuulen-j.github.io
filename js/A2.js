$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫志远，是河南工业大学的大一学生</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的家在内蒙古科尔沁草原</div>",2000);
	c.load("<div class='bef_comment writecode'>&nbsp;*下面，让我们来点实际的，看看我能用所学的知识做些什么</div>");
	...
	c.load("<div class='code writecode'>&nbsp;<span class='bef_key'>background</span>: <span class='bef_value'>#e96f92</span>;</div>");
	c.setClass("html", [{
		"name": "background",
		"val": "#e96f92"
	}]);
	*/
	...
	c.load("<div class='code writecode'>&nbsp;<span class='bef_key'>background</span>: <span class='bef_value'>rgba(0,0,0,0.3)</span>;</div>");
	c.setClass("pre:not(:empty)", [{
		"name": "background",
		"val": "rgba(0,0,0,0.3)"
	}]);
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	c.load("<p><div class='code writecode'><span class='bef_selector'>.comment</span>&nbsp;{ <span class='bef_key'>color</span>: <span class='bef_value'>Greenyellow</span>; <span class='bef_key'>font-style</span>: <span class='bef_value'>italic</span>; }</div>");
	...
	w.load("<p><div class='writecode'>志远</div>");
	w.load("<div class='writecode'>学生(河南工业大学)</div>");
	/*
	w.load("<div class='writecode'>前端/NodeJS 开发工程师</div></p>");
	*/
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:524101765@qq.com</li>");
	w.load("<li class='writecode'>blog:<a href='https://temuulenj.github.io/temuulenj' target='_blank'>temuulenj.github.io/temuulenj</a></li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/Temuulenj' target='_blank'>https://github.com/Temuulenj</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>兴趣爱好</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>喜欢动物(猫，狗)</li>");
	w.load("<li class='writecode'>呼麦，马头琴</li>");
	/*
	...
	*/
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:524101765</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:13253353036</div>");
